...
final class GetNumberClearedTests: XCTestCase {//todo
    ...
    func testsGetNumberCleared() throws {
        ...
        isAssert(
                actual: testGetNumberCleared(amount: "±§!@#$&*:[]`~%^&1000000", isUserEntered: true),
                expected: "1000000"
        )
        ...
        isAssert(
                actual: testGetNumberCleared(amount: " 1 234 567 890 ${kzt}", isUserEntered: false),
                expected: "1234567890"
        )
    ...
    private func testWithMinus() {
        ...
        isAssert(actual: testGetNumberCleared(amount: "1000zXьЛ00.-", isUserEntered: true), expected: "100000")
        isAssert(
                actual: testGetNumberCleared(amount: "1000zXьЛ00.-0", isUserEntered: true),
                expected: "1000000"
        )
        isAssert(
                actual: testGetNumberCleared(amount: "1000zXьЛ00.-00", isUserEntered: true),
                expected: "10000000"
        )
        isAssert(
                actual: testGetNumberCleared(amount: "1000zXьЛ00.-0-0", isUserEntered: true),
                expected: "10000000"
        )
        isAssert(
                actual: testGetNumberCleared(amount: "-1000zXьЛ00.-0-0", isUserEntered: true),
    ...
    private func isAssert(
            actual: Bool,
            expected: Bool,
            objectC_Zaebal_kostil: Bool = false
    ) {
        XCTAssertEqual(actual, expected)
    }
}
